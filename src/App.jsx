  ...
  return (
    <>
      <BrowserRouter>
        <Navbar />
        <Routes>
          <Route path="/" element={<All articles={articles}/>}></Route>
          <Route path="/fullstack" element={<Fullstack  articles={articles} />}></Route>
          <Route path="/data" element={<Data  articles={articles}/>}></Route>
          <Route path="/cyber" element={<Cyber  articles={articles} />}></Route>
          <Route path="/career" element={<Career  articles={articles}/>}></Route>
           </Routes>
      </BrowserRouter>
    </>
  );
